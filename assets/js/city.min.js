...
this.showProvincesOnDatalist=function(element,datalist){var str='<option selected disabled>Select Province</option>';for(let i in this.getProvinces()){str+='<option>'+this.p[i]+'</option>'}
this.p=[];document.querySelector(datalist).innerHTML='';document.querySelector(datalist).innerHTML=str;this.e=element;return this}
this.showCitiesOnText=function(province,element){var str='';var elem='';if((province.indexOf(".")!==-1||province.indexOf("#")!==-1)){elem=province}
else{for(let i in this.getCities(province)){str+='<option>'+this.c[i]+'</option>'}
elem=element}
this.c=[];document.querySelector(elem).innerHTML='';document.querySelector(elem).innerHTML=str;document.querySelector(this.e).onpoint=function(){var Obj=new City();Obj.showCities(this.value,elem)}
return this}}
