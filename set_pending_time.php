        ...
        <div class="modal-wrapper">
            ...
            <form class="container-fluid mx-auto" method="post" action="set_time.php">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col"><input type="text" class="form-control" name="pickup_time" placeholder="eg. 7:00"/></div>
                </div>
                <div class="form-row mt-2">
                ...
                <div class="form-row mt-2">
                        <div class="col-4">
                            <select id="year" name="pickup_year" class="form-control" oninput="this.className = 'form-control'">
                            <option value="2020">2020</option>
                            <option value="2021">2021</option>
                            <option value="2022">2022</option>
                            <option value="2023">2023</option>
                        ...
                        <div class="col">
                            <select id="month" name="pickup_month" class="form-control" oninput="this.className = 'form-control'">
                            <option value="1">January</option>
                            <option value="2">February</option>
                            <option value="3">March</option>
                            <option value="4">April</option>
                        ...
                        <div class="col-3">
                            <select id="day" name="pickup_day" class="form-control" oninput="this.className = 'form-control'">
                            <?php for($i = 1; $i < 32; $i++): ?>
                                <option value=<?php echo $i; ?>><?php echo $i; ?></option>
                            <?php endfor; ?>
                            </select>
